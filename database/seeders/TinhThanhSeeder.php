...
class TinhThanhSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('tinh_thanhs')->insert([
            ...
            ['tenTinhThanh' => 'Kiên Giang', 'trangThai' => 1],
            ['tenTinhThanh' => 'Quảng Ninh', 'trangThai' => 1],
            ['tenTinhThanh' => 'Long An', 'trangThai' => 1],
            ['tenTinhThanh' => 'Cao Bằng', 'trangThai' => 1],
            ['tenTinhThanh' => 'Hải Phòng', 'trangThai' => 1],
