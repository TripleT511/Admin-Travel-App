        ...
        <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('quanAn.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text-light" name="tenQuan" placeholder="Tên quán">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text-light" name="soDienThoai" placeholder="Số điện thoại">
                </div>
                <div class="form-group">
